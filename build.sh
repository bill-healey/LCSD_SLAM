...
grep -q -F 'export ROS_PACKAGE_PATH=${ROS_PACKAGE_PATH}:~/git/LCSD_SLAM/ORB_SLAM2/Examples/ROS' ~/.bashrc || echo 'export ROS_PACKAGE_PATH=${ROS_PACKAGE_PATH}:~/git/LCSD_SLAM/ORB_SLAM2/Examples/ROS' >> ~/.bashrc
source ~/.bashrc
